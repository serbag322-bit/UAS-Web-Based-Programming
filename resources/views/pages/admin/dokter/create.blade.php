            ...
            <div class="mx-auto max-w-3xl">
                <div class="rounded-lg border border-gray-200 bg-white p-6">
                    ...
                    <div class="mb-6 border-b border-gray-200 pb-4">
                        <h1 class="text-2xl font-bold text-gray-900">Tambah Dokter Baru</h1>
                        <p class="mt-1 text-sm text-gray-600">Isi form di bawah untuk menambah dokter</p>
                    </div>
